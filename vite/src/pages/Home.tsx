        ...
        <div className="relative z-10 w-full max-w-[1600px] mx-auto px-6 md:px-12 mt-16">
          <div className="max-w-3xl hero-content">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-6">
              ...
              <Link to="/about" className="border border-slate-500 text-white px-8 py-4 text-sm font-bold tracking-widest uppercase hover:bg-white/10 hover:border-white transition-colors">
                Corporate Overview
              </Link>
            </div>
          </div>
      ...
      <section id="portfolio" ref={portfolioRef} className="py-32 bg-slate-50">
        <div className="max-w-[1600px] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {/* ElectrifAI Card */}
            <Link to="/electrifai" className="portfolio-card group bg-white border border-slate-200 hover:border-blue-300 transition-all duration-500 hover:shadow-2xl overflow-hidden flex flex-col">
            ...
            {/* Servicio AI Card */}
            <Link to="/servicio-ai" className="portfolio-card group bg-white border border-slate-200 hover:border-blue-300 transition-all duration-500 hover:shadow-2xl overflow-hidden flex flex-col">
              <div className="h-64 overflow-hidden relative">
                <div className="absolute inset-0 bg-[#0f172a]/40 z-10 group-hover:bg-transparent transition-colors duration-700"></div>
            ...
            {/* LeasifAI Card */}
            <Link to="/leasifai" className="portfolio-card group bg-white border border-slate-200 hover:border-blue-300 transition-all duration-500 hover:shadow-2xl overflow-hidden flex flex-col">
              <div className="h-64 overflow-hidden relative">
                <div className="absolute inset-0 bg-[#0f172a]/40 z-10 group-hover:bg-transparent transition-colors duration-700"></div>
      ...
      <section id="about" ref={aboutRef} className="py-32 bg-white">
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div className="about-content">
            ...
            <Link to="/about" className="inline-flex items-center text-blue-700 font-bold tracking-widest uppercase text-sm hover:text-blue-900 transition-colors group">
