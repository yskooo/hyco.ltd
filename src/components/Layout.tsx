        ...
        <div className="max-w-[1600px] mx-auto px-6 flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center h-full ml-auto space-x-10">
            <nav className="flex items-center h-full space-x-10">
              <Link to="/" className="text-[14px] font-semibold text-[#0f172a] hover:text-blue-700 h-full flex items-center border-b-2 border-transparent hover:border-blue-700 transition-colors">Home</Link>
              <Link to="/about" className="text-[14px] font-semibold text-[#0f172a] hover:text-blue-700 h-full flex items-center border-b-2 border-transparent hover:border-blue-700 transition-colors">About</Link>
              ...
              <div className="relative group h-full flex items-center">
                ...
                <div className="absolute top-full right-0 w-[600px] bg-white shadow-2xl border border-slate-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 flex p-6 gap-6 rounded-b-lg">
                  ...
                  <div className="w-2/3 grid grid-cols-2 gap-x-4 gap-y-2 border-l border-slate-100 pl-6">
                    <Link to="/electrifai" className="group/link p-3 hover:bg-slate-50 rounded-md transition-colors">
                    ...
                    <Link to="/servicio-ai" className="group/link p-3 hover:bg-slate-50 rounded-md transition-colors">
                    ...
                    <Link to="/leasifai" className="group/link p-3 hover:bg-slate-50 rounded-md transition-colors">
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="px-6 py-6 flex flex-col space-y-6">
              <Link to="/" className="text-lg font-serif font-bold text-[#0f172a] border-b border-slate-100 pb-2">Home</Link>
              <Link to="/about" className="text-lg font-serif font-bold text-[#0f172a] border-b border-slate-100 pb-2">About</Link>
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="pl-4 flex flex-col space-y-4 border-l-2 border-slate-100">
                  <Link to="/electrifai" className="text-base font-medium text-slate-600 hover:text-blue-700">ElectrifAI</Link>
                  <Link to="/servicio-ai" className="text-base font-medium text-slate-600 hover:text-blue-700">Servicio AI</Link>
                  <Link to="/leasifai" className="text-base font-medium text-slate-600 hover:text-blue-700">LeasifAI</Link>
                </div>
              </div>
        ...
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-20">
            ...
            <div>
              ...
              <ul className="space-y-4 text-[14px] text-slate-400">
                <li><Link to="/electrifai" className="hover:text-white transition-colors">ElectrifAI</Link></li>
                <li><Link to="/servicio-ai" className="hover:text-white transition-colors">Servicio AI</Link></li>
                <li><Link to="/leasifai" className="hover:text-white transition-colors">LeasifAI</Link></li>
            ...
            <div>
              <h4 className="text-[12px] font-bold uppercase tracking-widest mb-6 text-slate-300">Careers</h4>
              <ul className="space-y-4 text-[14px] text-slate-400">
                <li><a href="#" className="hover:text-white transition-colors">Life at Hardy & Co.</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Students & Graduates</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Experienced Professionals</a></li>
                <li><a href="#" className="hover:text-white transition-colors flex items-center">Search Jobs <span className="ml-1 text-[10px]">↗</span></a></li>
              </ul>
            </div>
          </div>
          
          <div className="border-t border-slate-800 pt-8 flex flex-col lg:flex-row justify-between items-start lg:items-center text-[12px] text-slate-500 space-y-6 lg:space-y-0">
            <p>&copy; {new Date().getFullYear()} Hardy & Co. All rights reserved.</p>
